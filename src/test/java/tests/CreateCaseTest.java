...
public class CreateCaseTest extends BaseTest {
	...
	@Test
	public void testCaseCreationFlow() {
		...
		CreateCase casePage = new CreateCase(page);
	      ...
	      page.locator("[id=\"CreateNewCase\\:caseName\"]").fill("case1");
	      page.getByText("Case Name * Description800 Characters Categories * Add new CategoryMoney").click();
	      page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next >>")).click();   
	      FileChooser fileChooser = page.waitForFileChooser(() -> {
	    	    page.getByText("BrowseUpload").click();  // This opens the native file picker
	    	});
	 ...
	 @Test
	    public void testCaseCreationFlowWithAllCombinations() {
	        LoginPage loginPage = new LoginPage(page);
